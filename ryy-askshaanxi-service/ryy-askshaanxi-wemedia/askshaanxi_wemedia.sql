...
Source Database       : askshaanxi_wemedia
...
*/
CREATE DATABASE IF NOT EXISTS askshaanxi_wemedia DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE askshaanxi_wemedia;
SET NAMES utf8;
SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `power_channel`;
CREATE TABLE `power_channel` (
                                 `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
                                 `name` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '权力部门名称',
                                 `jurisdiction` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '管辖内容描述',
                                 `province_id` int(11) unsigned DEFAULT NULL COMMENT '管辖省市',
                                 `city_id` int(11) unsigned DEFAULT NULL COMMENT '管辖市区',
                                 `county_id` int(11) unsigned DEFAULT NULL COMMENT '管辖区县',
                                 `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '权力部门描述',
                                 `status` tinyint(1) unsigned DEFAULT NULL,
                                 `ord` tinyint(3) unsigned DEFAULT NULL COMMENT '默认排序',
                                 `created_time` datetime DEFAULT NULL COMMENT '创建时间',
                                 PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='机关部门信息表';

-- ----------------------------
-- Records of wm_channel
-- ----------------------------
INSERT INTO `power_channel` VALUES ('0', '权力机关', '', '1', '1', '12','','1', '12', '2021-04-18 10:55:41');
INSERT INTO `power_channel` VALUES ('1', '行政机关', '', '1', '1', '1', '','1', '1','2021-04-18 12:25:30');
INSERT INTO `power_channel` VALUES ('2', '审判机关', '', '1', '1', '4', '','1', '4', '2021-04-18 10:55:41');
INSERT INTO `power_channel` VALUES ('3', '公安机关', '', '1', '1', '5', '', '1', '5','2021-04-18 10:55:41');
INSERT INTO `power_channel` VALUES ('4', '监察机关', '', '1', '1', '6', '', '1', '6', '2021-04-18 10:55:41');
INSERT INTO `power_channel` VALUES ('5', '军事机关', '', '1', '1', '7', '','1', '7', '2021-04-18 10:55:41');
INSERT INTO `power_channel` VALUES ('6', '司法机关', '', '1', '1', '10', '本机关协调刑法、婚姻法、劳务法等相关问题','1', '10','2021-04-18 10:55:41');
...
CREATE TABLE `wm_material` (
  ...
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='图文素材信息表';

-- ----------------------------
-- Records of wm_material
-- ----------------------------
INSERT INTO `wm_material` VALUES ('67', '4', 'http://192.168.200.130:9000/leadnews/2021/04/26/a73f5b60c0d84c32bfe175055aaaac40.jpg', '0', '0', '2021-04-26 00:14:01');
INSERT INTO `wm_material` VALUES ('68', '4',  'http://192.168.200.130:9000/leadnews/2021/04/26/d4f6ef4c0c0546e69f70bd3178a8c140.jpg', '0', '0', '2021-04-26 00:18:20');
INSERT INTO `wm_material` VALUES ('69', '4', 'http://192.168.200.130:9000/leadnews/2021/04/26/5ddbdb5c68094ce393b08a47860da275.jpg', '0', '0', '2021-04-26 00:18:27');
INSERT INTO `wm_material` VALUES ('70', '4', 'http://192.168.200.130:9000/leadnews/2021/04/26/9f8a93931ab646c0a754475e0c4b0a98.jpg', '0', '0', '2021-04-26 00:18:34');
INSERT INTO `wm_material` VALUES ('71', '4', 'http://192.168.200.130:9000/leadnews/2021/04/26/ef3cbe458db249f7bd6fb4339e593e55.jpg', '0', '0', '2021-04-26 00:18:39');
