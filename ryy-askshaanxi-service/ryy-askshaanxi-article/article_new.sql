CREATE DATABASE IF NOT EXISTS askshaanxi_article DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE askshaanxi_article;
SET NAMES utf8;
/*
...
CREATE TABLE `article_votes` (
                                 `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
                                 `article_id` bigint(20) unsigned DEFAULT NULL COMMENT '文章ID',
                                 `user_id` bigint(20) unsigned DEFAULT NULL COMMENT '投票用户ID',
                                 `created_time` datetime DEFAULT NULL COMMENT '创建时间',
                                 PRIMARY KEY (`id`) USING BTREE,
                                 KEY `idx_article_id` (`article_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1383828014650150915 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='APP已发布文章内容表';
...
CREATE TABLE `article_comments` (
                                    `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
                                    `article_id` bigint(20) unsigned DEFAULT NULL COMMENT '文章ID',
                                    `user_id` bigint(20) unsigned DEFAULT NULL COMMENT '评论用户ID',
                                    `created_time` datetime DEFAULT NULL COMMENT '创建时间',
